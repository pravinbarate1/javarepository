...
public class UserService {
	...
	@DELETE
	//@Path("/users/{id:(/id/[^/]+?)?}")
	@Path("/protected/accountLists{accountListName:(/[^/]+?)?}")
	public Response deleteUser(@PathParam("accountListName") String accountListName)
			throws URISyntaxException {
		System.out.println("accountListName = "+accountListName);
